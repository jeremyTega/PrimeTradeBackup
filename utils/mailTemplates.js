function loginNotificationMail(user, timestamp, ipAddress, userAgent) {
    ...
    <body>
        <!-- Header with Logo -->
        <div class="header">
            <img src="https://res.cloudinary.com/dsml73vio/image/upload/v1715115266/prime-trade-logo/waivvtghqnxnmylvrkcn.png" alt="PRIME TRADE">
        </div>
...
const KycVericationMail = (savedKycDoc) => {
    ...
    <body>
        <div class="header">
            <img src="https://res.cloudinary.com/dsml73vio/image/upload/v1715115266/prime-trade-logo/waivvtghqnxnmylvrkcn.png" alt="PrimeTrade">
        </div>
        <div class="content">
...
function forgetMail(link){
    ...
    <body>
            ...
            <div class="header">
                <img src="https://res.cloudinary.com/dsml73vio/image/upload/v1715115266/prime-trade-logo/waivvtghqnxnmylvrkcn.png" alt="CITADEL INV" class="image">
        ...
        function ticketCreationNotificationMail(user, ticketData) {
            ...
            <body>
                <!-- Header with Logo -->
                <div class="header">
                    <img src="https://res.cloudinary.com/dsml73vio/image/upload/v1715115266/prime-trade-logo/waivvtghqnxnmylvrkcn.png" alt="CITADEL INV">
                </div>
...
<body>
  <div class="email-container">
    ...
    <div class="body">
      ...
      <p>
        This holiday season, Prime Trade is excited to share some festive cheer by offering a special bonus of <strong>$1,000</strong> to all our valued customers.
      </p>
      <p>
      ...
      <div class="cta">
        <a href="mailto:primetradeexchang@gmail.com">Reply Now</a>
      </div>
      <p>
        Best wishes for the season,<br>
        The Prime trade exchange
      </p>
    </div>
    <div class="footer">
      <p>© 2024 prime trade. All rights reserved.</p>
